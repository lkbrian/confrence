...
export const schedule: ScheduleDay[] = [
  {
    ...
    items: [
      ...
      { time: '1200 - 1300', activity: 'Plenary 2: Mentoring Civility – Relationship between Church and State', facilitator: 'Jeff Coleman' },
  ...
  },
  {
    ...
    items: [
      ...
      { time: '0845 - 0900', activity: 'Devotions', facilitator: 'Rev. Peter Ngok' },
...
export const plenaryTopics: Topic[] = [
  {
    ...
    speaker: 'Bishop David Kipsoi',
  },
  {
    code: 'P2',
    topic: 'Mentoring Civility: Relationship between Church and State',
    brief: 'Transgenerational mentorship bridges the gap between institutional church traditions and modern political leadership. It provides a framework for seasoned faith leaders to pass on ethical wisdom to the next generation of civil servants, blending spiritual morality with good governance to address societal challenges.',
    speaker: 'Jeff Coleman',
  },
  {
    code: 'P3',
